...
<?php
    ...
    //
        // Preparation de chemin pour les logs ce la banque
        $logfile="/var/www/html/front/projectCG/public/banque/logs/".date("Y_m");
        if (!(file_exists($logfile))) { mkdir($logfile,0777); }
        $logfile.="/log_".date("Ymd").".log";
	//$logfile="/var/www/html/front/projectCG/public/banque/log.log";
