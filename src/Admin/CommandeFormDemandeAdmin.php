...
{
    protected $baseRoutePattern = 'attente-formulaire';
    protected $baseRouteName = 'attente-formulaire';
    ...
    protected function configureRoutes(RouteCollection $collection)
    {
        ...
        $collection->add('newDemandeOfCommande', $this->getRouterIdParameter().'/new-demande-of-commande');
    }
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        ...
        ->add('_action', null, [
            'actions' => [ 
                ...
                'demandeCreate' => [
                    'template'=>'CRUD/list__commande_formulaire_demande.html.twig'
                ]
            ],
