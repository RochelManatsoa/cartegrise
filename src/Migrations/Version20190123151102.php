 ...
 */
final class Version20190123151102 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE documents_type_demande (documents_id INT NOT NULL, type_demande_id INT NOT NULL, INDEX IDX_94D097875F0F2752 (documents_id), INDEX IDX_94D097879DEA883D (type_demande_id), PRIMARY KEY(documents_id, type_demande_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
