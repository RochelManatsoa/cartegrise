 ...
 */
final class Version20190111074211 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_9B76551FC54C8C93 ON fichier');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9B76551FC54C8C93 ON fichier (type_id)');
    }
}
