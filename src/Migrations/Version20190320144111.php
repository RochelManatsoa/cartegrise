 ...
 */
final class Version20190320144111 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE client_dpt_naissance client_dpt_naissance VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
