...
class MailManager
{
    ...
    const SENDER_MAIL = "service.client@carte-grise-officiel.fr";
    ...
    public function sendEmail($emails=[], $template,string $object="Carte Grise Officiel", $params, $attachments=[], $cc=[], $from='service.client@carte-grise-officiel.fr')
    {
